        ...
        <div className="chatting-box">
              ...
              return (
                <>
                  ...
                  {chat.user !== isLogin.userId && (
                    <>
                      <p key={index} className="message-notme-box">
                        {chat.user}:
                      </p>
          ...
          {sendId ? (
            <div className="chatting-input-box">
              ...
              />
              <button onClick={handleSubmitMessage} disabled={sendId ? false : true}>
                보내기
              </button>
            </div>
          ) : (
